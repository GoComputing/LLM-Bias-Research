...
def paraphrase_text(llm, text, return_raw_response=True, original_on_failure=True):
...
def main(args):
    ...
    for query_info in tqdm(dataset['queries']):
        ...
        new_description, response = paraphrase_text(paraphraser_llm, old_description)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset-path', required=True, type=str, help='Dataset to be attacked. It can be generated by the script `evaluate_bias.py`')
